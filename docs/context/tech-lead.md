...
- **2026-06-04 - SMART EDIT: MODEL-LEVEL DELETE shipped (fixed-bar, undoable, both surfaces re-derive) + two P1 hardening fixes. Branch `feat/edit-delete`. NOT committed (left in the worktree for in-browser verification). 442 JS tests green (was 421; +21), typecheck + build green.** This is the proper delete the P1 stopgap-pull (entry below) deferred; pitch editing, undo/redo, dual-surface sync, and edit-mode-OFF-as-a-true-no-op are all untouched.
